...
def printParagraph1(pdf)
  ...
  printSubHeading(pdf)
	...
	pdf.text("We will use " + @controller.getNoun() + " to " + @controller.getVerb() + " our systems. This will allow us to easily " + @controller.getVerb() + " our " + @controller.getNoun() + ". Within six months we expect that our " + @controller.getAdjective() + " " + @controller.getNoun() + " will bring " + rand(99).to_s + "% more value to our " + @controller.getAdjective() + " " + @controller.getNoun())
